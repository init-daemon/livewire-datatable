            ...
            <div>
                <span class="relative z-0 inline-flex rounded-md shadow-sm">
                    <span>
                        ...
                        @else
                        <button wire:click="previousPage('page')" rel="prev"
                    ...
                    <span wire:key="paginator-page{{ $page }}">
                        ...
                        <span aria-current="page">
                            <span
                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-blue-600 border border-blue-600 cursor-default leading-5 select-none">{{
                                $page }}</span>
                        </span>
                        @else
                    ...
                    <span>
                        {{-- Next Page Link --}}
                        @if ($paginator->hasMorePages())
                        <button wire:click="nextPage('page')" rel="next"
